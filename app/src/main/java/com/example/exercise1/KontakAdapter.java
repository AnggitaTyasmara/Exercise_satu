...
public class KontakAdapter extends BaseAdapter {
    ...
    public KontakAdapter(Context context) {
        ...
        this.arrayList.addAll(KontakMahasiswa.classNamaArrayList);
    }
    ...
    public int getCount() {
        ...
        return KontakMahasiswa.classNamaArrayList.size();
    }
    ...
    public Object getItem(int i) {
        ...
        return KontakMahasiswa.classNamaArrayList.get(i);
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        holder.name.setText(KontakMahasiswa.classNamaArrayList.get(i).getName());
